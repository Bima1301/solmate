...
export default function Chat() {
    ...
    return (
        <main className='relative w-full h-full overflow-hidden rounded-2xl dark:border-slate-700 dark:bg-slate-800/90 dark:hover:shadow-slate-900/20 border-slate-200 bg-white/90'>

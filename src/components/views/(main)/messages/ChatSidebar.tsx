...
export default function ChatSidebar({ open = true, onClose }: ChatSidebarProps) {
    ...
    return (
        <div className={cn("size-full md:flex flex-col border-e md:w-64 flex-shrink-0", open ? 'flex' : 'hidden')}>
            <MenuHeader
                onClose={onClose}
            />
            <ChannelList

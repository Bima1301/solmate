...
import { useUpdateProfileMutation } from '@/store/mutations/user'
...
import CropImageDialog from '@/components/secondary/CropImageDialog'
...
interface AvatarInputProps {
    ...
    onImageCropped: (blo: Blob | null) => void
}
    ...
    return (
        <>
            ...
            >
                ...
                <span className='absolute inset-0 m-auto flex size-12 items-center justify-center rounded-full bg-black bg-opacity-30 text-white transition-colors duration-200 group-hover:bg-opacity-20'>
                    <Camera size={24} />
                </span>
            </button>
            {imageToCrop && (

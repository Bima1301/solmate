...
export default function MessageButton({ initialState, pathname }: MessageButtonProps) {
    const { data } = useQuery({
    ...
    return (
        <Link
            className={buttonVariants({
                className: `w-full flex !justify-start gap-3 h-12 transition-all duration-300 ${pathname === '/messages'
